    ...
    public partial class SignUpForm : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    MessageBox.Show($"You succesfully autorized! Your id: {actClient.GetClient(LoginEdit.Text).UserID}");
                ...
                {
                    MessageBox.Show($"You succesfully autorized! Your id: {op.GetOperator(LoginEdit.Text).UserID}");
                ...
                {
                    MessageBox.Show($"You succesfully autorized! Your id: {manager.GetManager(LoginEdit.Text).UserID}");
                ...
                {
                    MessageBox.Show($"You succesfully autorized! Your id: {another.GetSpecialist(LoginEdit.Text).UserID}");
                ...
                {
                    MessageBox.Show($"You succesfully autorized! Your id: {admin.GetAdmin(LoginEdit.Text).UserID}");
